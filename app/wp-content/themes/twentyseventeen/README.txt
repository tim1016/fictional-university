...
For more information about REIsavvy please go to https://codex.wordpress.org/Twenty_Seventeen.

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in REIsavvy in the search form and press the 'Enter' key on your keyboard.
...
REIsavvy WordPress Theme, Copyright 2016 WordPress.org
REIsavvy is distributed under the terms of the GNU GPL
...
REIsavvy bundles the following third-party resources:
